...
from funcs.ml import tourney_sim_test, get_teams, prep_model, train_model, get_teams, section
...
def simulate_probs(input_dir, output_dir, YEAR, sims, n):
    ...
    with open(f"test_cases/test_case_{YEAR}.pkl", "rb") as f:
    ...
    for i in range(1, sims + 1):
        ...
        prob_df = pd.DataFrame(data = prob, index = teams, columns = ["Champions", "Finals", "F4", "E8", "S16", "R32", "R64"])
    ...
    avg_df.to_csv(f"{output_dir}/avg_prob_df.csv")
